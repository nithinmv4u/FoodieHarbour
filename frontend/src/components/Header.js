...
import logo from '../assets/FoodieHarbour_logo.png'; 
    ...
    return (
        ...
        <div className='flex justify-between items-center p-2 bg-orange-600 drop-shadow-xl'>
            ...
            <div className="flex items-center w-2/12 justify-around font-bold text-white">
                ...
                {
                    user ? <button className="hover:text-yellow-200"  onClick={() => {
                        logoutUser();
                    }}>Logout</button> : <Link to={'/login'}><button className="hover:text-yellow-200">Login</button></Link>
                }
            </div>
        </div>
        </>
